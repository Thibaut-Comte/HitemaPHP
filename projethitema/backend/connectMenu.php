                        ...
                        if(!empty($_SESSION["username"]))
                        {
                            ...
                            <div class="dropdown">
                             ...
                             <div class="dropdown-menu">
                                 <a class="dropdown-item" href="http://localhost/projethitema/backend/administration.php"> Administration </a>
                                <a class="dropdown-item" href="http://localhost/projethitema/backend/Disconnect.php">Se déconnecter</a>
                             </div>   
                            </div>
                        <?php
                         }
