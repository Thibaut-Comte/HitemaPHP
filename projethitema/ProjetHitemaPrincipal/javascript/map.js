...
function getMarkers() {
	...
	{					
				...
				marker.bindPopup("<div ><center><h3>Réservation </h3></center><form action='Reservation.php' method ='post'><center><input style='display:none' name='ID' value='"+value.ID+"' required><strong><input style='border:none;font-weight:bold;margin-bottom:5px;' name='Hotel' value='"+value.Name+"'></strong><br><img  width='200px' height='100px' src='../imgHotel/"+value.Image+"'></center><hr><div class='row'><div class='col'><input type ='date' class='form-control' name='dateArrivee' required></div><div class='col'><input type ='date' class='form-control' name='dateDepart' required></div></div></br><input type ='number' name='nbVoyageurs'  required class='form-control' placeholder='Nombre de personnes' min='1' max='10'><br><center><button type ='submit' class='btn btn-primary bnt-lg' name='Reservation'  onclick='Reservation' > Réserver </button></center></form></div>");
